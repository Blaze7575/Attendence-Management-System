...
function Dashboard() {
    ...
    const goTo = () => {
        window.location.href = "/TClassD/Details"
    }
                                    ...
                                    if (i % 2 == 0) {
                                        ...
                                        return (
                                            <tr className='h-[3vw] whitespace-normal'>
                                                ...
                                                <td className='py-[.5vw] text-center font-semibold bg-[#e8e8e8] border-l-[2px] border-[#212221c1] flex justify-between'>
                                                    <div className='pt-[.5vw] ml-[6vw] inline-block '>A%</div>
                                                    <button className=' px-[1vw] py-[.5vw] mr-[.2vw] rounded-[4px] bg-[#187db4] text-[#ffffff]
                                                                    hover:bg-[#3a89b4] '
                                                        onClick={goTo}>
                                                        Details
                                                    </button>
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td className='py-[.5vw] text-center font-semibold bg-[#ffffff] border-l-[2px] border-[#212221c1]'>{d.id}</td>
                                                <td className='py-[.5vw] text-center font-semibold bg-[#ffffff] border-l-[2px] border-[#212221c1] flex justify-between'>
                                                    <div className='pt-[.5vw] ml-[6vw]  inline-block '>A%</div>
                                                    <button className=' px-[1vw] py-[.5vw] mr-[.2vw] rounded-[4px] bg-[#187db4] text-[#ffffff]
                                                                    hover:bg-[#3a89b4] '
                                                        onClick={goTo}>
